...
public class GeneratePasswordBookForSpecificHostOperator implements TransformInterface, RunningConfig
{

    private static final Log LOG = LogFactory.getLog(GeneratePasswordBookForSpecificHostOperator.class);
    private static boolean shutdown = true;
    private static final String PATH = "/SpecificPasswordBook";
    private static final Integer BATCH_SIZE = 1000;
    private String zookeeper_addr;
    private String topic = "com.scistor.process.operator.impl.GeneratePasswordBookForSpecificHostOperator";
    ...
    public void init(Map<String, String> config, ArrayBlockingQueue<Record> queue) {
        ...
        this.specificHost = config.get("specificHost");
        this.queue = queue;
